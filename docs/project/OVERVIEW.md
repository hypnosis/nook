...
- Спрятать и показать иконки за разделитель.
- Полоска-бар своих ярлыков под строкой меню (по клику на `<`).
- Автоскрытие по таймеру.
- Настройки: горячая клавиша для переключения и автозапуск при входе в систему.
- Современная иконка приложения и аккуратный внешний вид.
